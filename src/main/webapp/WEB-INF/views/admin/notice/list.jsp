						...
						<div class="row">
							...
							<div class="col-md-5">
								<div class="float-right">
									<button type="button" class="btn btn-sm btn-info" id="btnAdd"><i class='fas fa-edit'></i> 글쓰기</button>
								</div>
							</div>
						</div>
						<div class="row">
...
<script>
	...
	$("#listTable tbody").on("click", "tr", function () {
		...
		self.location = "/admin/notice/edit/" + noti_code;
	});

	$("#btnAdd").on("click", function () {
		self.location = "/admin/notice/edit";
	});
